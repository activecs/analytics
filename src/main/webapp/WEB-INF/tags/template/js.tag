...
<script type="text/javascript" src="<c:url value='/resources/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js'/>"></script>
...
<script type="text/javascript" src="<c:url value='/resources/plugins/chartjs/Chart.min.js'/>"></script>

<!-- AdminLTE App -->
<script type="text/javascript" src="<c:url value='/resources/js/app.min.js'/>" ></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script type="text/javascript" src="<c:url value='/resources/js/pages/dashboard2.js'/>"></script>
